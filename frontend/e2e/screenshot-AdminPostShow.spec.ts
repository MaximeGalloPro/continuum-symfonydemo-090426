...
test('capture AdminPostShowPage', async ({ page }) => {
  ...
  await expect(page.getByTestId('admin-post-show-page')).toBeVisible({ timeout: 5000 })
  ...
  await page.screenshot({
    path: 'screenshots/AdminPostShowPage.png',
    fullPage: true
  })
})
